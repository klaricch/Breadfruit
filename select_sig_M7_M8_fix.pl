...
foreach my $pep_file (@pep_files) {
	...
	if ($chi2_value >= 5.9915){ #chi2 with two degrees freedom p<= .05 significance 
		system "cp $name\.phy /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_M1_M2_M7_M8/fix";
		system "cp sites_test_out_7_8_$name /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_M1_M2_M7_M8/fix";
		system "cp RAxML_bestTree\.$name\.tree /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_M1_M2_M7_M8/fix";
		system "cp sites_test_out_1_2_$name /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_M1_M2_M7_M8/fix/M2";
