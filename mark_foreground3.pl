...
my $chi2_test_value = $bonferroni_hash{$count};foreach $key2(@array){
	...
	print "$chi2_test_value\n\n";
		...
		system "cp $name\.phy /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_branch_site";
		system "cp branch_site_test_fixed_$name\_$key2 /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_branch_site";
		system "cp branch_site_test_estimated_$name\_$key2 /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_branch_site";
		system "cp $name\_$key2.tree /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/survive_branch_site";
	}
