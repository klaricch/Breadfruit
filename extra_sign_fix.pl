...
foreach my $pep_file (@pep_files) {
	...
	while (<IN>){
		...
		system "mv $name\_fix.pep /home/zerega/data/kristen/protein_ortho/with_reference/orthologs/fix";
		close IN;
...
closedir DIR;
	...
	while (<IN_CDS>){
		...
		system "mv $name\_fix.cds /home/zerega/data/kristen/protein_ortho/with_reference/orthologs/fix";
