...
# should have folder labeled "fastqc_reports" in working directory
# may have to alter script depending on # of seqs in adapter list file
...
########################################################################################################
########################################################################################################
system "Trinity.pl --seqType fq --JM 100G --left A_WT_R1_out.paired_$fileR1 --right A_WT_R2_out.paired_$fileR2 --output trinity_out_dir_$fileR1 --full_cleanup --CPU 10"; 
########################################################################################################
########################################################################################################
#
#                                  LONGEST ISOFORM
