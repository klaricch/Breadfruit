...
#this script algins a sample to itself with bwa and carries out the neccessary step to eventually run samtools depth
#on command line: parallel -j5 /home/zerega/data/kristen/scripts/align_sample_to_itself.pl {1} :::: list_all_samples.txt
