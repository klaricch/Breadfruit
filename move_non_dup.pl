...
foreach my $pep_file (@pep_files) {
	...
	if ($total_seqs != $duplicates) { #dont want to copy the file over if the duplicate # of seqs equals the total # of seqs
		...
		system "cp $name.phy /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/";
		system "cp RAxML_bestTree\.$name\.tree /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep2/";
	};
