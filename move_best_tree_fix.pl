...
foreach my $pep_file (@pep_files) {
	$pep_file =~ /(\d+)\.tree/;
	$name = $1;
	system "cp $pep_file /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep1/fix";
		system "cp $name.phy /home/zerega/data/kristen/protein_ortho/with_reference/paml_files/corrected_paml_files_GTRGAMMA/prep1/fix";
		}
