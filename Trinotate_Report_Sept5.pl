...
system "/data/mjohnson/transdecoder/TransDecoder -t /home/zerega/data/kristen/assemblies/$sample --CPU 15 --reuse --search_pfam /data/mjohnson/transdecoder/pfam/Pfam-AB.hmm.bin";
...
system "blastx -query /home/zerega/data/kristen/assemblies/$sample -db /data/mjohnson/trinotate/uniprot_sprot.fasta -num_threads 15 -max_target_seqs 1 -evalue .00001 -outfmt 6 > blastx_$sample.outfmt6";
...
system "/data/mjohnson/trinity/trinityrnaseq_r20131110/util/get_Trinity_gene_to_trans_map.pl /home/zerega/data/kristen/assemblies/$sample > $sample.gene_trans_map";
...
system "/data/mjohnson/trinotate/Trinotate_r20131110/Trinotate Trinotate.sqlite init --gene_trans_map $sample.gene_trans_map --transcript_fasta /home/zerega/data/kristen/assemblies/$sample --transdecoder_pep $sample.transdecoder.pep";
